...
export function CTASection() {
  ...
  return (
    <section className="py-24 w-full flex justify-center items-center px-4 md:px-6">
      ...
      >
        <div className="relative overflow-hidden rounded-[48px] border border-border bg-card shadow-sm min-h-[600px] flex flex-col items-center justify-center transition-all duration-500">
          ...
          <div className="relative z-10 px-6 max-w-4xl mx-auto text-center flex flex-col items-center">
            ...
            <h2 className="font-sans text-5xl md:text-7xl lg:text-8xl font-bold tracking-tight text-foreground mb-8 leading-[1.05]">
              Validated <br />
